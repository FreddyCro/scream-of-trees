<template>
  <div id="app">
    ...
    >
      <div slot="article">
        <SlideCardTitle
          first="種樹救海岸線"
        />
        <p>全台各地的海岸線逐漸退縮，我們的國土，正被大海一點一滴吞沒。</p>
        <p>為防止海岸線後退，政府及民間組織正積極在海岸種下一排排綠樹，要靠這些海岸林抓牢土地、抵禦風沙，緊守台灣海岸線。</p>
      </div>
    </SlideCard>
    <SlideCard
      index="4"
    ...
    >
      <div slot="article">
        <p>近5年來，慈心已在全台12縣市沿岸種下45萬棵樹。</p>
        <p>除了新北市萬里，也能在雲林縣台西鄉、嘉義縣布袋鎮等地見到他們的種樹成果。</p>
      </div>
    </SlideCard>
    <SlideCard
      index="10"
