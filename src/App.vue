  ...
  <div id="app">
    ...
    >
      <div class="slide-card-article" slot="article">
        <p class="p--first">為什麼森林的樹高大挺拔<br>我們種的樹卻歪七扭八？</p>
      </div>
    </SlideCard>
    <SlideCard
      index="2"
    ...
    >
      <div class="slide-card-article" slot="article">
        <p class="p--first">我們拚命種樹<br>卻種出許多處境悲慘的樹</p>
      </div>
    </SlideCard>
    <SlideCard
      index="3"
    ...
    >
      <div class="slide-card-article" slot="article">
        <p class="p--first">在這些樹身上<br>看不到樹該有的樣貌</p>
      </div>
    </SlideCard>
    <SlideCard
      index="5"
    ...
    >
      <div class="slide-card-article" slot="article">
        <p class="p--first">卻看到他們用殘破的身軀<br>訴說一個個令人痛心的遭遇</p>
      </div>
    </SlideCard>
    <SlideCard
      index="6"
    ...
    >
      <div class="slide-card-article" slot="article">
        ...
        <p>每年植樹節，都可見到多位大官帶頭種樹，「種樹救地球」儼然成為全民運動，但相關機構及民眾常缺乏種樹觀念，導致種下去的樹缺乏管理維護，若仔細觀察我們周圍的樹，會發現許多樹的處境令人心寒。</p>
        <p>那些被大官們風光種下的大官樹，後來怎麼了？如何避免不健康的行道樹成為馬路上的殺人兇器？《聯合報》採訪團隊走訪各縣市種樹現場，記錄了不同棵樹的幸與不幸，期許台灣社會不僅要會種樹，更要懂得「把樹種好」。</p>
        <p><br></p>
        <p><br></p>
      </div>
      <RelatedArticles slot="full" />
      <div slot="footer">
        <FooterEditor>
          <div>
            <p>採訪</p>
